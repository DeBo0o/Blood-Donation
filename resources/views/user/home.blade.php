...
<div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/bg_image_1.png);">
    <div class="hero-section">
        <div class="container text-center wow zoomIn">
            <span class="subhead">Let's Save your life </span>
...
<footer class="page-footer">
    <div class="container">
        <div class="row px-md-3">
            ...
            <div class="col-sm-6 col-lg-3 py-3">
                <h5>Contact</h5>
                <p class="footer-link mt-2">Egyptian Red Crescent</p>
                <a href="#" class="footer-link">+(20) 2 25985555</a>
                <a href="#" class="footer-link">erc@egyptianrc.org</a>
